...
import { SquarePen, Hash, Image, Eraser, Scissors, FileText, FilePen } from 'lucide-react'
...
export const AiToolsData = [
  ...
  },
  {
    ...
    description:
      "Create a professional resume in minutes with good ATS score.",
    Icon: FilePen,
    bg: { from: "#3548F2", to: "#4AB0D9" },
