...
import { ArrowDownToLine, Scissors, Sparkles } from "lucide-react";
    ...
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      >
        ...
        <input
          ...
          required
        />
        <p className="mt-6 text-sm font-medium">Describe Object Name</p>
        <input
      ...
      <div className="w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96">
        ...
        {!content ? (
          ...
          <div className="mt-3 h-full relative group rounded-lg overflow-hidden">
            <img
              src={content}
              alt="image"
            ...
            <div className="absolute inset-0 group-hover:bg-gradient-to-b from-transparent to-black/80">
              <ArrowDownToLine
                ...
                className="absolute w-6 h-6 right-4 bottom-4 text-white cursor-pointer hidden group-hover:block"
              />
            </div>
          </div>
        )}
